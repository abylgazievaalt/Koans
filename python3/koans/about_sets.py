...
class AboutSets(Koan):
    def test_sets_make_keep_lists_unique(self):
        ...
        self.assertEqual({'MacLeod', 'Ramirez', 'MacLeod', 'Matunas', 'MacLeod', 'Malcolm', 'MacLeod'}, 
    ...
    def test_set_have_arithmetic_operators(self):
        ...
        self.assertEqual({'Leonidas', 'MacLeod', 'Wallace', 'Willie'}, warriors | scotsmen)
